        ...
        {TABS.map((tab) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center gap-1 px-4 py-2 min-h-[44px] min-w-[44px] transition-all duration-200 cursor-pointer btn-press focus:outline-none focus:ring-2 focus:ring-[#2e96ff] focus:ring-offset-2 focus:ring-offset-[#1a1b1f] rounded-md ${
