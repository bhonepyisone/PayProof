        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={`mx-2 mb-1 flex items-center gap-3 rounded-md px-3 py-2.5 transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#2e96ff] focus:ring-offset-2 focus:ring-offset-[#1a1b1f] ${
                isActive
